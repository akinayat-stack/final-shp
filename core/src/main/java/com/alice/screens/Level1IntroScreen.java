...
public class Level1IntroScreen implements Screen {
    ...
    public Level1IntroScreen(AliceGame game) {
        this.game = game;
        this.camera = new OrthographicCamera();
        this.camera.setToOrtho(false, Constants.VIEWPORT_W, Constants.VIEWPORT_H);
        this.background = game.assets.get("level1.png", Texture.class);
        this.playButtonTex = game.assets.get("play.png", Texture.class);
