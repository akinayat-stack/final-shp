...
public class Level2IntroScreen implements Screen {
    ...
    public Level2IntroScreen(AliceGame game) {
        this.game = game;
        this.camera = new OrthographicCamera();
        this.camera.setToOrtho(false, Constants.VIEWPORT_W, Constants.VIEWPORT_H);
        this.background = game.assets.get("level2.png", Texture.class);
        this.playButtonTex = game.assets.get("play2.png", Texture.class);
    ...
    private void startGame() {
        game.setScreen(new GameScreen(game, 2, 0, Constants.PLAYER_LIVES));
        dispose();
    }
